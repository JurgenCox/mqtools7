...
namespace MqApi.Drawing.Image.Quantizers{
	public sealed class WuQuantizer : IQuantizer{
		...
		public QuantizedImage Quantize(ImageBase image, int maxColors){
			...
			int colorCount = NumUtil.Clamp(maxColors, 1, 256);
			Clear();
		...
		private double Variance(Box cube){
			...
			double xx = m2[GetPaletteIndex(cube.R1, cube.G1, cube.B1, cube.A1)] -
			            m2[GetPaletteIndex(cube.R1, cube.G1, cube.B1, cube.A0)] -
			            m2[GetPaletteIndex(cube.R1, cube.G1, cube.B0, cube.A1)] +
			            m2[GetPaletteIndex(cube.R1, cube.G1, cube.B0, cube.A0)] -
			            m2[GetPaletteIndex(cube.R1, cube.G0, cube.B1, cube.A1)] +
			            m2[GetPaletteIndex(cube.R1, cube.G0, cube.B1, cube.A0)] +
			            m2[GetPaletteIndex(cube.R1, cube.G0, cube.B0, cube.A1)] -
			            m2[GetPaletteIndex(cube.R1, cube.G0, cube.B0, cube.A0)] -
			            m2[GetPaletteIndex(cube.R0, cube.G1, cube.B1, cube.A1)] +
			            m2[GetPaletteIndex(cube.R0, cube.G1, cube.B1, cube.A0)] +
			            m2[GetPaletteIndex(cube.R0, cube.G1, cube.B0, cube.A1)] -
			            m2[GetPaletteIndex(cube.R0, cube.G1, cube.B0, cube.A0)] +
			            m2[GetPaletteIndex(cube.R0, cube.G0, cube.B1, cube.A1)] -
			            m2[GetPaletteIndex(cube.R0, cube.G0, cube.B1, cube.A0)] -
			            m2[GetPaletteIndex(cube.R0, cube.G0, cube.B0, cube.A1)] +
