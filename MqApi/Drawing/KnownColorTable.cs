namespace MqApi.Drawing{
	internal static class KnownColorTable{
		...
		public static int FromWin32Value(int value){
			return Encode(255, (value >> win32RedShift) & 0xFF, (value >> win32GreenShift) & 0xFF,
				(value >> win32BlueShift) & 0xFF);
		}
		private static void UpdateSystemColors(int[] colorTable1){
			// Colors from a default XP desktop for use by UI designers in ASP.NET: <email>[....]</email>
			colorTable1[(int) KnownColor.ActiveBorder] = unchecked((int) 0xffd4d0c8);
			colorTable1[(int) KnownColor.ActiveCaption] = unchecked((int) 0xff0054e3);
			colorTable1[(int) KnownColor.ActiveCaptionText] = unchecked((int) 0xffffffff);
			colorTable1[(int) KnownColor.AppWorkspace] = unchecked((int) 0xff808080);
			colorTable1[(int) KnownColor.ButtonFace] = 0x0;
			colorTable1[(int) KnownColor.ButtonHighlight] = 0x0;
			colorTable1[(int) KnownColor.ButtonShadow] = 0x0;
			colorTable1[(int) KnownColor.Control] = unchecked((int) 0xffece9d8);
			colorTable1[(int) KnownColor.ControlDark] = unchecked((int) 0xffaca899);
			colorTable1[(int) KnownColor.ControlDarkDark] = unchecked((int) 0xff716f64);
			colorTable1[(int) KnownColor.ControlLight] = unchecked((int) 0xfff1efe2);
			colorTable1[(int) KnownColor.ControlLightLight] = unchecked((int) 0xffffffff);
			colorTable1[(int) KnownColor.ControlText] = unchecked((int) 0xff000000);
			colorTable1[(int) KnownColor.Desktop] = unchecked((int) 0xff004e98);
			colorTable1[(int) KnownColor.GradientActiveCaption] = 0x0;
			colorTable1[(int) KnownColor.GradientInactiveCaption] = 0x0;
			colorTable1[(int) KnownColor.GrayText] = unchecked((int) 0xffaca899);
			colorTable1[(int) KnownColor.Highlight] = unchecked((int) 0xff316ac5);
			colorTable1[(int) KnownColor.HighlightText] = unchecked((int) 0xffffffff);
			colorTable1[(int) KnownColor.HotTrack] = unchecked((int) 0xff000080);
			colorTable1[(int) KnownColor.InactiveBorder] = unchecked((int) 0xffd4d0c8);
			colorTable1[(int) KnownColor.InactiveCaption] = unchecked((int) 0xff7a96df);
			colorTable1[(int) KnownColor.InactiveCaptionText] = unchecked((int) 0xffd8e4f8);
			colorTable1[(int) KnownColor.Info] = unchecked((int) 0xffffffe1);
			colorTable1[(int) KnownColor.InfoText] = unchecked((int) 0xff000000);
			colorTable1[(int) KnownColor.Menu] = unchecked((int) 0xffffffff);
			colorTable1[(int) KnownColor.MenuBar] = 0x0;
			colorTable1[(int) KnownColor.MenuHighlight] = 0x0;
			colorTable1[(int) KnownColor.MenuText] = unchecked((int) 0xff000000);
			colorTable1[(int) KnownColor.ScrollBar] = unchecked((int) 0xffd4d0c8);
			colorTable1[(int) KnownColor.Window] = unchecked((int) 0xffffffff);
			colorTable1[(int) KnownColor.WindowFrame] = unchecked((int) 0xff000000);
			colorTable1[(int) KnownColor.WindowText] = unchecked((int) 0xff000000);
		}
	}
}