...
namespace MqApi.Util{
	public static class StringUtils{
		...
		public static readonly HashSet<string> numericColDefaultNames = new HashSet<string>(new[]{
			...
			"mass difference to range max",
			"sample 1/k0 - library 1/k0", "ml score", "tag length", "theor. isotope correlation", "time correlation",
			"delta ml score", "pg.quantity", "pg.normalised", "pg.maxlfq", "genes.quantity", "genes.normalised",
			"genes.maxlfq",
			"genes.maxlfq.unique", "q.value", "pep", "global.q.value", "protein.q.value", "pg.q.value",
			"global.pg.q.value",
