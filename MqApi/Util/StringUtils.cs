...
namespace MqApi.Util{
	public static class StringUtils{
		...
		public static readonly HashSet<string> categoricalColDefaultNames = new HashSet<string>(new[]{
			...
			"majority library index", "library indices", "species", "matched", "crosslink type", "crosslinkingtype","crosslink product type",
			...
			"dia mass range index", "sub-range", "isdecoy", "fitsrt", "fitsims", "fitssupplentry", "hasprecursor",
			"range index"
		});
		...
		public static readonly HashSet<string> numericColDefaultNames = new HashSet<string>(new[]{
			...
			"fragments found m/z", "fragments not found m/z",
			"fragments found correlation", "fragments not found correlation"
		});
