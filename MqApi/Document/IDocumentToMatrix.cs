...
namespace MqApi.Document{
	public interface IDocumentToMatrix : IDocumentActivity, IToMatrix{
		void ProcessData(IDocumentData inData, IMatrixData outData, Parameters param, ref IMatrixData[] supplTables,
