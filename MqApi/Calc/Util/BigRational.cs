...
namespace MqApi.Calc.Util{
	internal class BigRational : IFormattable, IComparable, IComparable<BigRational>, IEquatable<BigRational>{
		...
		public BigRational(long numerator, long denominator) : this(new BigInteger(numerator),
			new BigInteger(denominator)){
		}
		public BigRational(int numerator, int denominator) : this(new BigInteger(numerator),
			new BigInteger(denominator)){
		}
		public BigRational(ulong numerator, ulong denominator) : this(new BigInteger(numerator),
			new BigInteger(denominator)){
		}
		public BigRational(uint numerator, uint denominator) : this(new BigInteger(numerator),
			new BigInteger(denominator)){
		}
