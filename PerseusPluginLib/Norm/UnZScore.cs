...
namespace PerseusPluginLib.Norm{
	public class UnZScore : IMatrixProcessing{
		...
		public string Url =>
            "https://cox-labs.github.io/coxdocs/unzscore.html";
		...
		public Parameters GetParameters(IMatrixData mdata, ref string errorString){
			...
			Parameters rowSubParams =
				new Parameters(new SingleChoiceParam("Mean", rowMeanInd){Values = mdata.NumericColumnNames},
			...
			Parameters columnSubParams =
				new Parameters(new SingleChoiceParam("Mean", colMeanInd){Values = mdata.NumericRowNames},
