...
namespace PerseusPluginLib.Norm{
	public class SubtractRowCluster : IMatrixProcessing{
		...
		public string Url =>
            "https://cox-labs.github.io/coxdocs/subtractrowcluster.html";
		...
		public Parameters GetParameters(IMatrixData mdata, ref string errorString){
			return
				new Parameters(new SingleChoiceParam("Indicator column"){Values = mdata.CategoryColumnNames},
					new StringParam("Value", "+"){
						Help =
							"Rows matching this term in the indicator column will be used as control for the normalization."
					});
		}
	}
}