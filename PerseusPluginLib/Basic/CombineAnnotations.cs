...
namespace PerseusPluginLib.Basic{
	public class CombineAnnotations : IMatrixProcessing{
		...
		public string HelpOutput =>
			"A new categorical column is generated indicating the presence of any of these terms.";
		...
		public string Url
			=> "https://cox-labs.github.io/coxdocs/combineannotations.html";
		...
		public Parameters GetParameters(IMatrixData mdata, ref string errorString){
			...
			return
				new Parameters(new MultiChoiceParam("Categories"){
					...
					new BoolParam("Inverse")
						{Help = "If true, those rows are indicated which do not contain any of the search terms."});
		}
	}
}