...
namespace PerseusPluginLib.Basic{
	public class SummaryStatisticsColumns : IMatrixProcessing{
		...
		public string Url
			=> "https://cox-labs.github.io/coxdocs/summarystatisticscolumns.html";
			...
			return
				new Parameters(new List<Parameter>{
					new MultiChoiceParam("Columns"){
						...
						Help =
							"Specify here the columns for which the summary statistics quantities should be calculated."
					},
					new MultiChoiceParam("Calculate",
						ArrayUtils.ConsecutiveInts(SummaryStatisticsRows.procNames.Length)){
		...
		public void ProcessData(IMatrixData mdata, Parameters param, ref IMatrixData[] supplTables,
			...
			mdata.SetAnnotationColumns(new List<string>(new[]{"Columns"}), new List<string[]>(new[]{colNames}),
				categoryRowNames, transformedCategories, numericRowNames, transformedNumeric, new List<string>(),
				new List<double[][]>());
		}
