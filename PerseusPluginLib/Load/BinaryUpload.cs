	...
	public class BinaryUpload : IMatrixUpload{
		...
		private static readonly HashSet<byte> replace =
			new HashSet<byte>(new byte[]{
				0x7F, 0x80, 0x81, 0x84, 0x85, 0x88, 0x8C, 0x8D, 0x8E, 0x8F, 0x90, 0x91, 0x92, 0x95, 0x99, 0x9A, 0x9B,
				0x9D, 0x9E,
				0xAD
			});
