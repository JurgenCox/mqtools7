...
namespace PerseusPluginLib.Rearrange{
	...
	public class ConvertMultiNumeric : IMatrixProcessing{
		...
		public string HelpOutput =>
			"If n multi-numeric columns are selected, n numeric columns will be added to the matrix.";
		public string[] HelpDocuments => new string[0];
		public int NumDocuments => 0;
		public string Url
			=> "https://cox-labs.github.io/coxdocs/convertmultinumeric.html";
		...
		public Parameters GetParameters(IMatrixData mdata, ref string errorString){
			...
			return
				new Parameters(new MultiChoiceParam("Operation"){
					Values = names,
					Help =
						"How should the numbers in a cell of the multi-numeric columns be transformed to a single number?"
