...
namespace PerseusPluginLib.Rearrange{
	public class RenameColumnsRegexp : IMatrixProcessing{
		...
		public string Url
			=> "https://cox-labs.github.io/coxdocs/renamecolumnsregexp.html";
		...
		public void ProcessData(IMatrixData mdata, Parameters param, ref IMatrixData[] supplTables,
			...
			switch (parameter.Value){
				...
				case 4:
					for (int i = 0; i < mdata.CategoryColumnCount; i++){
						mdata.MultiNumericColumnNames[i] =
							pattern.Replace(mdata.MultiNumericColumnNames[i], replacementStr);
					}
					break;
			}
