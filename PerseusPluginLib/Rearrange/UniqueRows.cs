...
namespace PerseusPluginLib.Rearrange{
	public class UniqueRows : IMatrixProcessing{
		...
		public string Url =>
            "https://cox-labs.github.io/coxdocs/uniquerows.html";
		...
		public void ProcessData(IMatrixData mdata, Parameters param, ref IMatrixData[] supplTables,
			...
			ParseParameters(param, out Func<double[], double> combineNumeric, out Func<string[], string> combineString,
		...
		private void ParseParameters(Parameters param, out Func<double[], double> combineNumeric,
			out Func<string[], string> combineString,
			out Func<string[][], string[]> combineCategory, out Func<double[][], double[]> combineMultiNumeric){
