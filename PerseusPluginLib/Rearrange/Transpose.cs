...
namespace PerseusPluginLib.Rearrange{
	public class Transpose : IMatrixProcessing{
		...
		public string Url =>
            "https://cox-labs.github.io/coxdocs/transpose.html";
		...
		public void ProcessData(IMatrixData mdata, Parameters param, ref IMatrixData[] supplTables,
			...
			mdata.SetAnnotationColumns(new List<string>(new[]{"Name"}), new List<string>(new[]{"Name"}),
				...
				GetCategoryRows(mdata), mdata.NumericRowNames, mdata.NumericRowDescriptions, mdata.NumericRows,
				new List<string>(),
			...
			mdata.SetAnnotationRows(stringColumnNames, stringColumnDescriptions, stringColumns, categoryColumnNames,
				categoryColumnDescriptions, categoryColumns, numericColumnNames, numericColumnDescriptions,
				numericColumns,
