...
namespace PerseusPluginLib.Rearrange{
	public class SearchTextColumns : IMatrixProcessing{
		...
		public string Url
			=> "https://cox-labs.github.io/coxdocs/searchtextcolumns.html";
		...
		public Parameters GetParameters(IMatrixData mdata, ref string errorString){
			return
				new Parameters(new StringParam("Find what"),
					new SingleChoiceParam("Look in"){Values = mdata.StringColumnNames},
