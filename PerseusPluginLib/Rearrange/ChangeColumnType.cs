...
namespace PerseusPluginLib.Rearrange{
	public class ChangeColumnType : IMatrixProcessing{
		...
		public string Url =>
            "https://cox-labs.github.io/coxdocs/changecolumntype.html";
			...
			return
				new Parameters(
					new MultiChoiceParam("Columns")
						{Values = values, Help = "Select here the column whose type should be changed."},
		...
		private static string[] GetStringSelection(){
			return new[]{"Categorical", "Main", "Numerical", "Multi numerical"};
		}
		private static string[] GetCategoricalSelection(){
			return new[]{"Numerical", "Text"};
		}
		private static string[] GetExpressionSelection(){
			return new[]{"Numerical"};
		}
		private static string[] GetNumericSelection(){
			return new[]{"Categorical", "Main", "Text"};
		}
		private static string[] GetMultiNumericSelection(){
			return new[]{"Text"};
		}
	}
}