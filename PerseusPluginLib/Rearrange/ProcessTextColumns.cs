...
namespace PerseusPluginLib.Rearrange{
	public class ProcessTextColumns : IMatrixProcessing{
		...
		public string Url
			=> "https://cox-labs.github.io/coxdocs/processtextcolumns.html";
		...
		private static void ProcessColMatch(IDataWithAnnotationColumns mdata, Regex regex, string replacement, int col,
			bool keepColumns, bool semicolons){
