...
namespace PerseusPluginLib.Rearrange{
	public class ExpandMultiNumeric : IMatrixProcessing{
		...
		public string Url
			=> "https://cox-labs.github.io/coxdocs/expandmultinumeric.html";
		...
		private int GetEntryCount(int row, IMatrixData mdata, IList<int> multiNumCols, IList<int> stringCols,
			out string err){
