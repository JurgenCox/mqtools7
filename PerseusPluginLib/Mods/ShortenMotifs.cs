...
namespace PerseusPluginLib.Mods{
	public class ShortenMotifs : IMatrixProcessing{
		...
		public string Url
			=> "https://cox-labs.github.io/coxdocs/shortenmotifs.html";
		public Parameters GetParameters(IMatrixData mdata, ref string errString){
			...
			return
				new Parameters(
					...
					new IntParam("Length", 11)
						{Help = "Flanking regions of this length will be kept surrounding the central position."});
		}
