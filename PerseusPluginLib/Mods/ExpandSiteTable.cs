...
namespace PerseusPluginLib.Mods{
	public class ExpandSiteTable : IMatrixProcessing{
		...
		public string Url =>
            "https://cox-labs.github.io/coxdocs/expandsitetable.html";
		...
		public void ProcessData(IMatrixData mdata, Parameters param, ref IMatrixData[] supplTables,
			...
			mdata.SetAnnotationColumns(
				new List<string>(ArrayUtils.Concat(mdata.StringColumnNames, new[]{"Unique identifier"})),
		...
		private static int[,] SortNumberedNames(IList<string> names, IList<string> descriptions, int maxIndex,
			ref string errorString, out string[] allSuffixes, out string[] allPrefixes,
