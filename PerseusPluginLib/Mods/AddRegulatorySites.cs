...
namespace PerseusPluginLib.Mods{
	public class AddRegulatorySites : IMatrixProcessing{
		...
		public string Url
			=>
                "https://cox-labs.github.io/coxdocs/addregulatorysites.html";
		...
		public void ProcessData(IMatrixData mdata, Parameters param, ref IMatrixData[] supplTables,
			...
			PhosphoSitePlusParser.ParseRegulatorySites(out string[] seqWins, out string[] accs, out string[] function,
				out string[] process, out string[] protInteract,
