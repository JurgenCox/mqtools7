...
namespace PerseusPluginLib.Mods{
	public class AddModificationCounts : IMatrixProcessing{
		...
		public string Description =>
			"Count how many modifcations are known in PSP for the specified modification type(s).";
		...
		public void ProcessData(IMatrixData mdata, Parameters param, ref IMatrixData[] supplTables,
			...
			for (int index = 0; index < mods.Length; index++){
				...
				PhosphoSitePlusParser.ParseKnownMods(filename, out string[] seqWins, out string[] accs,
					out string[] pubmedLtp, out string[] pubmedMs2, out string[] cstMs2, out string[] species);
