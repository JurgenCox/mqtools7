...
namespace PerseusPluginLib.AnnotCols{
	public class CategoryCounting : IMatrixProcessing{
		...
		public string Url
			=> "https://cox-labs.github.io/coxdocs/categorycounting.html";
		...
		private static void CreateMatrixData(CountingResult result, IMatrixData data, int minCount,
			...
			data.Values.Set(ex);
			data.SetAnnotationColumns(new List<string>(), new List<string[]>(), catColNames, catCols, numColNames,
				numCols,
