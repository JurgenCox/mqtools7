	...
	public class Class1 : IMatrixMultiProcessing{
		...
		public string Description
			=>
				...
				"columns that will be edited while the second matrix is used to define the key-value table.";
		...
		public string Url => "https://cox-labs.github.io/coxdocs/changecolumnnames.html"; 
