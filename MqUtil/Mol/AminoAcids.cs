...
namespace MqUtil.Mol{
	public static class AminoAcids{
		...
		public static readonly AminoAcid alanine = new AminoAcid("C3H5NO", "Alanine", 
			"Ala", 'A', 7.4,
			new[]{"GCT", "GCC", "GCA", "GCG"}, "hydrophobic aliphatic", true, 1.8);

		public static readonly AminoAcid arginine = new AminoAcid("C6H12N4O", "Arginine", 
			"Arg", 'R', 4.2,
			new[]{"CGT", "CGC", "CGA", "CGG", "AGA", "AGG"}, "charged basic", true, -4.5);

		public static readonly AminoAcid asparagine = new AminoAcid("C4H6N2O2", "Asparagine", 
			"Asn", 'N', 4.4,
			new[]{"AAT", "AAC"}, "polar neutral", true, -3.5);

		public static readonly AminoAcid asparticAcid = new AminoAcid("C4H5NO3", "Aspartic acid",
			"Asp", 'D', 5.9,
			new[]{"GAT", "GAC"}, "charged acidic", true, -3.5);

		public static readonly AminoAcid cysteine = new AminoAcid("C3H5NOS", "Cysteine", 
			"Cys", 'C', 3.3, new[]{"TGT", "TGC"},
			"polar neutral", true, 2.5);

		public static readonly AminoAcid glutamicAcid = new AminoAcid("C5H7NO3", "Glutamic acid",
			"Glu", 'E', 5.8,
			new[]{"GAA", "GAG"}, "charged acidic", true, -3.5);

		public static readonly AminoAcid glutamine = new AminoAcid("C5H8N2O2", "Glutamine", 
			"Gln", 'Q', 3.7,
			new[]{"CAA", "CAG"}, "polar neutral", true, -3.5);

		public static readonly AminoAcid glycine = new AminoAcid("C2H3NO", "Glycine", 
			"Gly", 'G', 7.4,
			new[]{"GGT", "GGC", "GGA", "GGG"}, "", true, -0.4);

		public static readonly AminoAcid histidine = new AminoAcid("C6H7N3O", "Histidine", 
			"His", 'H', 2.9,
			new[]{"CAT", "CAC"}, "charged basic", true, -3.2);

		public static readonly AminoAcid isoleucine = new AminoAcid("C6H11NO", "Isoleucine", 
			"Ile", 'I', 3.8,
			new[]{"ATT", "ATC", "ATA"}, "hydrophobic aliphatic", true, 4.5);

		public static readonly AminoAcid leucine = new AminoAcid("C6H11NO", "Leucine", 
			"Leu", 'L', 7.6,
			new[]{"TTA", "TTG", "CTT", "CTC", "CTA", "CTG"}, "hydrophobic aliphatic", true, 3.8);

		public static readonly AminoAcid lysine = new AminoAcid("C6H12N2O", "Lysine", 
			"Lys", 'K', 7.2, new[]{"AAA", "AAG"},
			"charged basic", true, -3.9);

		public static readonly AminoAcid methionine = new AminoAcid("C5H9NOS", "Methionine", 
			"Met", 'M', 1.8, new[]{"ATG"},
			"hydrophobic aliphatic", true, 1.9);

		public static readonly AminoAcid phenylalanine = new AminoAcid("C9H9NO", "Phenylalanine",
			"Phe", 'F', 4,
			new[]{"TTT", "TTC"}, "hydrophobic aromatic", true, 2.8);

		public static readonly AminoAcid proline = new AminoAcid("C5H7NO", "Proline", 
			"Pro", 'P', 5,
			new[]{"CCT", "CCC", "CCA", "CCG"}, "", true, -1.6);

		public static readonly AminoAcid serine = new AminoAcid("C3H5NO2", "Serine", 
			"Ser", 'S', 8.1,
			new[]{"TCT", "TCC", "TCA", "TCG", "AGT", "AGC"}, "polar neutral", true, -0.8);

		public static readonly AminoAcid threonine = new AminoAcid("C4H7NO2", "Threonine", 
			"Thr", 'T', 6.2,
			new[]{"ACT", "ACC", "ACA", "ACG"}, "polar neutral", true, -0.7);

		public static readonly AminoAcid tryptophan = new AminoAcid("C11H10N2O", "Tryptophan", 
			"Trp", 'W', 1.3, new[]{"TGG"},
			"hydrophobic aromatic", true, -0.9);

		public static readonly AminoAcid tyrosine = new AminoAcid("C9H9NO2", "Tyrosine", 
			"Tyr", 'Y', 3.3, new[]{"TAT", "TAC"},
			"hydrophobic aromatic", true, -1.3);

		public static readonly AminoAcid valine = new AminoAcid("C5H9NO", "Valine", 
			"Val", 'V', 6.8,
			new[]{"GTT", "GTC", "GTA", "GTG"}, "hydrophobic aliphatic", true, 4.2);

		public static readonly AminoAcid selenocysteine = new AminoAcid("C3H5NOSe", 
			"Selenocysteine", "Sec", 'U', 0.0,
			new[]{"TGA"}, "", false, 0.0);

		public static readonly AminoAcid pyrrolysine = new AminoAcid("C12H19N3O2", 
			"Pyrrolysine", "Pyl", 'O', 0.0,
			new[]{"TAG"}, "", false, 0.0);
