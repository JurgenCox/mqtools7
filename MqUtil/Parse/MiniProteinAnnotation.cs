...
namespace MqUtil.Parse{
	public class MiniProteinAnnotation{
		...
		public MiniProteinAnnotation(string geneName, string proteinName, IList<string> pfams, string[] pdbs,
			bool isReviewed,
		...
		public static Dictionary<string, MiniProteinAnnotation>
			ReadMapping(string filename, HashSet<string> allProtIds){
			...
			while ((line = reader.ReadLine()) != null){
				...
				Dictionary<FeatureType, List<UniprotFeature>> flist =
					new Dictionary<FeatureType, List<UniprotFeature>>();
				...
				MiniProteinAnnotation mpa =
					new MiniProteinAnnotation(geneName, proteinName, pfams, pdbs, isReviewed, flist);
